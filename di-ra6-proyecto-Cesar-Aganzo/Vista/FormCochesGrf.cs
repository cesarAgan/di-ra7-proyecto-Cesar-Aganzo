...
{    /// <summary>
     /// Formulario para graficos de prueba Coches.
     /// </summary>
    public partial class FormCochesGrf : Form
    {
        /// <summary>
        ...
        Form formPrincipal;
        /// <summary>
        /// Constructor del formulario que inicializa los componentes y carga los datos de coches desde un archivo JSON.
        /// </summary>
        public FormCochesGrf()
        {
            InitializeComponent();
            Controlador.Dao.CochesDaoJson.leerJson(cochesList);
        ...
        /// </summary>
        private void FormCochesGrf_Load(object sender, EventArgs e)
        {
            this.reportViewer1.LocalReport.ReportPath = "ReportCochesGrf.rdlc";
        ...
        /// </summary>
        private void FormCochesGrf_FormClosing(object sender, FormClosingEventArgs e)
        {
